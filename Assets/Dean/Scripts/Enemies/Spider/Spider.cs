...
public class Spider : MonoBehaviour, IDamageable
{
    ...
    private void CheckForObstacles()
    {
        ...
        bool ground1 = Physics2D.OverlapBox(check1Pos.position, checkSize1, 0f, obstacleLayer);
        bool ground2 = Physics2D.OverlapBox(check2Pos.position, checkSize2, 0f, obstacleLayer);
